...
addr_cerebellum = '10.162.177.248'
port_cerebellum = 9001
addr_hippocampus = '10.162.177.248'
port_hippocampus = 9003
addr_planner = '10.162.177.248'
port_planner = 9004
port_vision = 9005
...
with model:
    ...
    tank = tankudp.TankUDP(address='10.128.0.18')
    ...
    # external UDP inputs
    udpread_Cerebellum = nengo_pushbot.UDPReceiver(port_cerebellum, size_out=2) # Cereb. motor command
    ...
    udpsend_cerebellum = nengo_pushbot.UDPSender(addr_cerebellum, port_cerebellum, size_in=17)
